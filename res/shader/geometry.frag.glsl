...
uniform sampler2DArray material_albedo;
// uniform sampler2DArray material_normal;
...
void main() {  
    ...
    vec2 st1 = dFdx(frag_texture_coordinate.xy);
    vec2 st2 = dFdy(frag_texture_coordinate.xy);
