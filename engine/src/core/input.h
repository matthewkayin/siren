...
namespace siren {
    ...
    void input_process_mouse_motion(int x, int y);
    ...
    SIREN_API void input_get_mouse_position(int* x, int* y);
    SIREN_API void input_get_mouse_relative_position(int* delta_x, int* delta_y);
    SIREN_API void input_get_mouse_wheel_relative_position(int* delta_z);
}